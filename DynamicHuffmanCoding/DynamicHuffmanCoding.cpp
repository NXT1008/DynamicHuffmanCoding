...
int main()
{
    ...
    a.Initlialize();
//    char s[11] = {'a','b','r','a','c','a','d','a','b','r','a'};
//    char s[8] = {'a','a','r','d','v','a','r','k'};
    string s;
    input(s);
    ...
    cout << "M: "<<a.M <<" E: " << a.E <<" R: " <<a.R <<endl;
    for(int i =0; i< a.receive.length();i++){
        cout << a.receive[i];
    }
    cout << "\n = = = = = = = = = = = = = =><= = = = = = = = = = = = = = =\n";
    for (int i=0; i<n; i++){
    ...
    cout << "\nDecode : \n";
    d=0;
    while(d<a.receive.length()){
        int tmp = a.Decode();
        cout << "C[q]: "<< tmp <<"| ";
        cout << char(tmp + 'a' - 1)<< endl;
//      a.Update(tmp);
    }
    cout <<"Check: "<<a.V <<" "<<a.G[a.V] << " "<<a.G[a.G[a.V]];
//00000 000001 0010001 0 10000010 0 110000011 0 110 110 0
//00000 1 00001 100 0111 1 010 0 011011100 0110011001001
}
